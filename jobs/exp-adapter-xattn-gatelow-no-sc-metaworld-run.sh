#!/bin/bash
#SBATCH --job-name=gatelow-metaworld-run-no-sc
...
#SBATCH --output=logs/no-sc-gatelow-metaworld-run-%x-%j.out
#SBATCH --error=logs/no-sc-gatelow-metaworld-run-%x-%j.err
