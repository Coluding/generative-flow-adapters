#!/bin/bash
#SBATCH --job-name=triangle-gatelow-nobase
...
# Base-parity campaign (2026-07-21), ARM 2 of 4 — gatelow-nobase overfit with a
# RAW (uncapped) gate, no base input. The pure input ablation vs uxrst2k5.
#
...
#
# Readout: adapter_gate_mean and adapter_grad_norm from step 1.
#   gate pins ~0.99 + gradnorm dies ⇒ the gate trap alone suffices
#   (this arm then can't speak to the base-input question — that's arm 1's job)
#
